...
//  val connections = new mutable.ListBuffer[FakeConnectionPool]
//
...
//      server.start
//      servers += server
//      val connection = new FakeConnectionPool(1, server)
...
//
//      expect {
//        one(locator).findNode("a".getBytes) willReturn connections(0).reserve()
//        one(locator).findNode("b".getBytes) willReturn connections(1).reserve()
//        one(locator).findNode("c".getBytes) willReturn connections(2).reserve()
//      }
//
...
//
//      expect {
//        one(locator).findNode("a:a".getBytes) willReturn connections(0).reserve()
//        one(locator).findNode("a:b".getBytes) willReturn connections(0).reserve()
//        one(locator).findNode("a:c".getBytes) willReturn connections(0).reserve()
//      }
//
//      client.get(Array("a", "b", "c")) mustEqual Map("a" -> "apple", "b" -> "beach", "c" -> "conch")
//      for (s <- servers) {
...
////      connections(1).isServerDown must beFalse
////
////      expect {
////        one(locator).findNode("b".getBytes) willReturn connections(1)
...
////
////      client.get("b") must throwA[MemcacheServerException]
////      connections(1).isServerDown must beTrue
////
////      expect {
...
////    }
////
////    "not set the pool if should_rebalance_servers is set to false" in {
////      makeServers(List(
////        Receive(7) :: SkipAwaitConnection :: Disconnect :: Receive(7) :: Send("VALUE a 0 1\r\nb\r\nEND\r\n".getBytes) :: Nil
////      ))
////      pool.maxFailuresBeforeEjection = 1
////      client.shouldRebalancePool = false
////      expect {
////        one(locator).findNode("b".getBytes) willReturn connections(0)
////      }
////
////      client.get("b") must throwA[MemcacheServerException]
////      connections(0).isServerDown must beTrue
////
////      Time.advance(60.seconds)
////
////      expect {
////        never(locator).setPool(any)
////        one(locator).findNode("b".getBytes) willReturn connections(0)
////      }
////      client.get("b") mustEqual Some("b")
////    }
